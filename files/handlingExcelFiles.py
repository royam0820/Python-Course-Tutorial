...
#dat is a dictionary to hold zip codes (as strings) keys and count of defaults as value

os.chdir('/Users/roy/Documents/jupyterNotebooks/Python Crash Course')

wb = xl.load_workbook('excel-data.xlsx')
...
##workbook.save('../files/excel_data2.xlsx')
